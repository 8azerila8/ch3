...
class HomePageTests(SimpleTestCase):
    ...
    def test_url_availabli_by_name(self):
...
class CategoryPageTests(SimpleTestCase):
    ...
    def test_url_availibal_by_name(self):
    ...
    def test_template_content(self):
        response = self.client.get(reverse("category"))
        self.assertContains(response,"<h1>Category</h1>")

class GamesPageTests(SimpleTestCase):
    def test_url_exist_at_correct_location(self):
    ...
    def test_template_content(self):
        response = self.client.get(reverse("games"))
        self.assertContains(response,"<h1>some games</h1>")
